var data = [
  {
    image:
      "https://is4-ssl.mzstatic.com/image/thumb/j2OQb5dbAo6pqsNyY0Yzow/998x562.webp",
    episode: "EPISODE 1",
    title: "Emergency Landing In Tehran",
    description: "Tamar RAbinyan enters the heart of Tehran to neutralize army radar systems and enable Isreal's air force to bomb Iran's nuclear reactor.",
  ...
  {
    image:
      "https://is1-ssl.mzstatic.com/image/thumb/CDDjYOQUxheDrRKpjcmYPw/1478x832.webp",
      episode: "EPISODE 2",
      title: "Blood on Her Hands",
      description: "Tabrizi,local mossad agent,tries to help Tamar in any way possible while,revolutionary Gaurd officer Faraz is hot on TAnars trail",
      time: "45 min Apr 24,2020",
      tv: "<svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-tv' viewBox='0 0 16 16' ><path d='M2.5 13.5A.5.5 0 0 1 3 13h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zM13.991 3l.024.001a1.46 1.46 0 0 1 .538.143.757.757 0 0 1 .302.254c.067.1.145.277.145.602v5.991l-.001.024a1.464 1.464 0 0 1-.143.538.758.758 0 0 1-.254.302c-.1.067-.277.145-.602.145H2.009l-.024-.001a1.464 1.464 0 0 1-.538-.143.758.758 0 0 1-.302-.254C1.078 10.502 1 10.325 1 10V4.009l.001-.024a1.46 1.46 0 0 1 .143-.538.758.758 0 0 1 .254-.302C1.498 3.078 1.675 3 2 3h11.991zM14 2H2C0 2 0 4 0 4v6c0 2 2 2 2 2h12c2 0 2-2 2-2V4c0-2-2-2-2-2z'/></svg>",
      cc: "<svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-badge-cc' viewBox='0 0 16 16' ><path d='M3.708 7.755c0-1.111.488-1.753 1.319-1.753.681 0 1.138.47 1.186 1.107H7.36V7c-.052-1.186-1.024-2-2.342-2C3.414 5 2.5 6.05 2.5 7.751v.747c0 1.7.905 2.73 2.518 2.73 1.314 0 2.285-.792 2.342-1.939v-.114H6.213c-.048.615-.496 1.05-1.186 1.05-.84 0-1.319-.62-1.319-1.727v-.743zm6.14 0c0-1.111.488-1.753 1.318-1.753.682 0 1.139.47 1.187 1.107H13.5V7c-.053-1.186-1.024-2-2.342-2C9.554 5 8.64 6.05 8.64 7.751v.747c0 1.7.905 2.73 2.518 2.73 1.314 0 2.285-.792 2.342-1.939v-.114h-1.147c-.048.615-.497 1.05-1.187 1.05-.839 0-1.318-.62-1.318-1.727v-.743z'/><path d='M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z'/></svg>",
      Ad: "<svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-badge-ad' viewBox='0 0 16 16' ><path d='m3.7 11 .47-1.542h2.004L6.644 11h1.261L5.901 5.001H4.513L2.5 11h1.2zm1.503-4.852.734 2.426H4.416l.734-2.426h.053zm4.759.128c-1.059 0-1.753.765-1.753 2.043v.695c0 1.279.685 2.043 1.74 2.043.677 0 1.222-.33 1.367-.804h.057V11h1.138V4.685h-1.16v2.36h-.053c-.18-.475-.68-.77-1.336-.77zm.387.923c.58 0 1.002.44 1.002 1.138v.602c0 .76-.396 1.2-.984 1.2-.598 0-.972-.449-.972-1.248v-.453c0-.795.37-1.24.954-1.24z'/><path d='M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z'/></svg>",
  ...
  {
    image:
      "https://is1-ssl.mzstatic.com/image/thumb/un1QDTnqdMMlRXVONctjvA/1478x832.webp",
      episode: "EPISODE 3",
      title: "Yasamin's Girl",
      description:"Hiding with her aunt, Tamar goes underground and attempts to escape Iran.Faraz and Tabrizi broaden their searches for her",
  ...
  {
    image:
      "https://is5-ssl.mzstatic.com/image/thumb/nJ7m5kUMlIxFnHWViyuBVg/1478x832.webp",
      episode: "EPISODE 4",
      title: "Shakira and Sickboy",
      description: "When she finds a commune of young regime opponents Tamar takes Refuge with them-and becomes cloase with Milad.",
  ...
  {
    image:
      "https://is5-ssl.mzstatic.com/image/thumb/peWwDT3K8MSneiqtUBx9xg/1478x832.webp",
      episode: "EPISODE 5",
      title: "The Other Iran",
      description: " At the underground rave with Milad and the other commune members, Tamar most Prove her loyality.Faraz and Tabrizi reach a boling point.",
      time: "48 min Apr 24, 2020",
      tv: "<svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-tv' viewBox='0 0 16 16' ><path d='M2.5 13.5A.5.5 0 0 1 3 13h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zM13.991 3l.024.001a1.46 1.46 0 0 1 .538.143.757.757 0 0 1 .302.254c.067.1.145.277.145.602v5.991l-.001.024a1.464 1.464 0 0 1-.143.538.758.758 0 0 1-.254.302c-.1.067-.277.145-.602.145H2.009l-.024-.001a1.464 1.464 0 0 1-.538-.143.758.758 0 0 1-.302-.254C1.078 10.502 1 10.325 1 10V4.009l.001-.024a1.46 1.46 0 0 1 .143-.538.758.758 0 0 1 .254-.302C1.498 3.078 1.675 3 2 3h11.991zM14 2H2C0 2 0 4 0 4v6c0 2 2 2 2 2h12c2 0 2-2 2-2V4c0-2-2-2-2-2z'/></svg>",
    cc: "<svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-badge-cc' viewBox='0 0 16 16' ><path d='M3.708 7.755c0-1.111.488-1.753 1.319-1.753.681 0 1.138.47 1.186 1.107H7.36V7c-.052-1.186-1.024-2-2.342-2C3.414 5 2.5 6.05 2.5 7.751v.747c0 1.7.905 2.73 2.518 2.73 1.314 0 2.285-.792 2.342-1.939v-.114H6.213c-.048.615-.496 1.05-1.186 1.05-.84 0-1.319-.62-1.319-1.727v-.743zm6.14 0c0-1.111.488-1.753 1.318-1.753.682 0 1.139.47 1.187 1.107H13.5V7c-.053-1.186-1.024-2-2.342-2C9.554 5 8.64 6.05 8.64 7.751v.747c0 1.7.905 2.73 2.518 2.73 1.314 0 2.285-.792 2.342-1.939v-.114h-1.147c-.048.615-.497 1.05-1.187 1.05-.839 0-1.318-.62-1.318-1.727v-.743z'/><path d='M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z'/></svg>",
    Ad: "<svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-badge-ad' viewBox='0 0 16 16' ><path d='m3.7 11 .47-1.542h2.004L6.644 11h1.261L5.901 5.001H4.513L2.5 11h1.2zm1.503-4.852.734 2.426H4.416l.734-2.426h.053zm4.759.128c-1.059 0-1.753.765-1.753 2.043v.695c0 1.279.685 2.043 1.74 2.043.677 0 1.222-.33 1.367-.804h.057V11h1.138V4.685h-1.16v2.36h-.053c-.18-.475-.68-.77-1.336-.77zm.387.923c.58 0 1.002.44 1.002 1.138v.602c0 .76-.396 1.2-.984 1.2-.598 0-.972-.449-.972-1.248v-.453c0-.795.37-1.24.954-1.24z'/><path d='M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z'/></svg>",
  ...
  {
    image:
      "https://is2-ssl.mzstatic.com/image/thumb/pcpMO5qB7EMUqP0_EHx3DA/1478x832.webp",
      episode: "EPISODE 6",
      title: "The Engineer",
      description: "Tamar and Milad return to Tehran and blackmail their electric company contact.Kadosh tries to convice Gorev to approve tamars new plan.",
  ...
  {
    image:
      "https://is2-ssl.mzstatic.com/image/thumb/-Hsguf-1RCzUXUj7p_WcnA/1478x832.webp",
      episode: "EPISODE 7",
      title: "Tamar's Father",
    description: "The incident at the commune leaves Tamar shattered Kadosh tries to help her recover so they can set the power plant operation in motion",
      time: "46 min Apr 24, 2020",
      tv: "<svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-tv' viewBox='0 0 16 16' ><path d='M2.5 13.5A.5.5 0 0 1 3 13h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zM13.991 3l.024.001a1.46 1.46 0 0 1 .538.143.757.757 0 0 1 .302.254c.067.1.145.277.145.602v5.991l-.001.024a1.464 1.464 0 0 1-.143.538.758.758 0 0 1-.254.302c-.1.067-.277.145-.602.145H2.009l-.024-.001a1.464 1.464 0 0 1-.538-.143.758.758 0 0 1-.302-.254C1.078 10.502 1 10.325 1 10V4.009l.001-.024a1.46 1.46 0 0 1 .143-.538.758.758 0 0 1 .254-.302C1.498 3.078 1.675 3 2 3h11.991zM14 2H2C0 2 0 4 0 4v6c0 2 2 2 2 2h12c2 0 2-2 2-2V4c0-2-2-2-2-2z'/></svg>",
    cc: "<svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-badge-cc' viewBox='0 0 16 16' ><path d='M3.708 7.755c0-1.111.488-1.753 1.319-1.753.681 0 1.138.47 1.186 1.107H7.36V7c-.052-1.186-1.024-2-2.342-2C3.414 5 2.5 6.05 2.5 7.751v.747c0 1.7.905 2.73 2.518 2.73 1.314 0 2.285-.792 2.342-1.939v-.114H6.213c-.048.615-.496 1.05-1.186 1.05-.84 0-1.319-.62-1.319-1.727v-.743zm6.14 0c0-1.111.488-1.753 1.318-1.753.682 0 1.139.47 1.187 1.107H13.5V7c-.053-1.186-1.024-2-2.342-2C9.554 5 8.64 6.05 8.64 7.751v.747c0 1.7.905 2.73 2.518 2.73 1.314 0 2.285-.792 2.342-1.939v-.114h-1.147c-.048.615-.497 1.05-1.187 1.05-.839 0-1.318-.62-1.318-1.727v-.743z'/><path d='M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z'/></svg>",
    Ad: "<svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-badge-ad' viewBox='0 0 16 16' ><path d='m3.7 11 .47-1.542h2.004L6.644 11h1.261L5.901 5.001H4.513L2.5 11h1.2zm1.503-4.852.734 2.426H4.416l.734-2.426h.053zm4.759.128c-1.059 0-1.753.765-1.753 2.043v.695c0 1.279.685 2.043 1.74 2.043.677 0 1.222-.33 1.367-.804h.057V11h1.138V4.685h-1.16v2.36h-.053c-.18-.475-.68-.77-1.336-.77zm.387.923c.58 0 1.002.44 1.002 1.138v.602c0 .76-.396 1.2-.984 1.2-.598 0-.972-.449-.972-1.248v-.453c0-.795.37-1.24.954-1.24z'/><path d='M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z'/></svg>",
  ...
  {
    image:
      "https://is1-ssl.mzstatic.com/image/thumb/GxoSFc5MIl6-vf5dJIYJRQ/1478x832.webp",
      episode: "EPISODE 8",
      title: "Five Hours Untill The Bombing Run",
      description: "Season finale.with Israeli planes approaching the reactor Tamar Milad and Kadosh lanch an operation as Faraz closes in on them",
      time: "46 min Apr 24, 2020",
      tv: "<svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-tv' viewBox='0 0 16 16' ><path d='M2.5 13.5A.5.5 0 0 1 3 13h10a.5.5 0 0 1 0 1H3a.5.5 0 0 1-.5-.5zM13.991 3l.024.001a1.46 1.46 0 0 1 .538.143.757.757 0 0 1 .302.254c.067.1.145.277.145.602v5.991l-.001.024a1.464 1.464 0 0 1-.143.538.758.758 0 0 1-.254.302c-.1.067-.277.145-.602.145H2.009l-.024-.001a1.464 1.464 0 0 1-.538-.143.758.758 0 0 1-.302-.254C1.078 10.502 1 10.325 1 10V4.009l.001-.024a1.46 1.46 0 0 1 .143-.538.758.758 0 0 1 .254-.302C1.498 3.078 1.675 3 2 3h11.991zM14 2H2C0 2 0 4 0 4v6c0 2 2 2 2 2h12c2 0 2-2 2-2V4c0-2-2-2-2-2z'/></svg>",
    cc: "<svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-badge-cc' viewBox='0 0 16 16' ><path d='M3.708 7.755c0-1.111.488-1.753 1.319-1.753.681 0 1.138.47 1.186 1.107H7.36V7c-.052-1.186-1.024-2-2.342-2C3.414 5 2.5 6.05 2.5 7.751v.747c0 1.7.905 2.73 2.518 2.73 1.314 0 2.285-.792 2.342-1.939v-.114H6.213c-.048.615-.496 1.05-1.186 1.05-.84 0-1.319-.62-1.319-1.727v-.743zm6.14 0c0-1.111.488-1.753 1.318-1.753.682 0 1.139.47 1.187 1.107H13.5V7c-.053-1.186-1.024-2-2.342-2C9.554 5 8.64 6.05 8.64 7.751v.747c0 1.7.905 2.73 2.518 2.73 1.314 0 2.285-.792 2.342-1.939v-.114h-1.147c-.048.615-.497 1.05-1.187 1.05-.839 0-1.318-.62-1.318-1.727v-.743z'/><path d='M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z'/></svg>",
    Ad: "<svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='currentColor' class='bi bi-badge-ad' viewBox='0 0 16 16' ><path d='m3.7 11 .47-1.542h2.004L6.644 11h1.261L5.901 5.001H4.513L2.5 11h1.2zm1.503-4.852.734 2.426H4.416l.734-2.426h.053zm4.759.128c-1.059 0-1.753.765-1.753 2.043v.695c0 1.279.685 2.043 1.74 2.043.677 0 1.222-.33 1.367-.804h.057V11h1.138V4.685h-1.16v2.36h-.053c-.18-.475-.68-.77-1.336-.77zm.387.923c.58 0 1.002.44 1.002 1.138v.602c0 .76-.396 1.2-.984 1.2-.598 0-.972-.449-.972-1.248v-.453c0-.795.37-1.24.954-1.24z'/><path d='M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z'/></svg>",
...
var sgData = [
  {
    image:"https://is4-ssl.mzstatic.com/image/thumb/krpObBOoX2xTTKeQByyhxg/492x492ve.webp",
    name:"Niv Sultan",
    role:"Tamar Rabinian"
},
{
    image:"https://is2-ssl.mzstatic.com/image/thumb/YP6z_3Nt4eJNDdu7vbkA5Q/492x492ve.webp",
    name:"Shaun Toub",
    role:"Faraz Kamali"
},
{
    image:"https://is2-ssl.mzstatic.com/image/thumb/c2cA2ArMBXUJHOqTKvsONg/492x492ve.webp",
    name:"Navid Negahban",
    role:"Masoud Tabrizi"
},
{
    image:"https://is1-ssl.mzstatic.com/image/thumb/vA9sSPyAy0yRt2K1SC5-9g/492x492ve.webp",
    name:"Shervin Alenabi",
    role:"Milad Kahani"
},
{
    image:"https://is3-ssl.mzstatic.com/image/thumb/NSxoJ6i-7-uwLXTxuCY-uA/492x492ve.webp",
    name:"Manashe Noy",
    role:"Meir Gorev"
},
{
    image:"https://is3-ssl.mzstatic.com/image/thumb/c4e1nRsFW3LaqsLG9U8umg/492x492ve.webp",
    name:"Liraz Charhi",
    role:"Yael Kadosh"
},
{
    image:"https://is3-ssl.mzstatic.com/image/thumb/ACpRqvDnkizOrlvqReNgLg/492x492ve.webp",
    name:"Daniel",
    role:"Director"
},
{
    image:"https://is1-ssl.mzstatic.com/image/thumb/j7F8mF8aYw8W0z7wwaWO_w/492x492ve.webp",
    name:"Moshe Zonder",
    role:"Executive producer"
},
{
    image:"https://is1-ssl.mzstatic.com/image/thumb/B-FQbUKeH9YOA8POpPu3wg/492x492ve.webp",
    name:"Eldad Koblenz",
    role:"Executive producer"
},
{
    image:"https://is2-ssl.mzstatic.com/image/thumb/uLoFcZGRlIYhBuFrdIAhJA/492x492ve.webp",
    name:"Julien Leroux",
    role:"Executive Producer"
},
{
    image:"https://is2-ssl.mzstatic.com/image/thumb/KpCLAHWj6nN5MJDCFYcCaw/492x492ve.webp",
    name:"Peter Emerson",
    role:"Executive Producer"
},
{
    image:"https://is1-ssl.mzstatic.com/image/thumb/U-AVw-iun69tOHqEm7rDtQ/492x492ve.webp",
    name:"Alon aranya",
    role:"Executive Producer"
},
{
  image:"https://is4-ssl.mzstatic.com/image/thumb/PFFuZZ5festUHzHuJmr_yQ/492x492ve.webp",
  name:"Dana Eden",
  role:"Executive Producer"
},
{
  image:"https://is2-ssl.mzstatic.com/image/thumb/HoZNuMLCzojjPle1dfDjdQ/492x492ve.webp",
  name:"Dana Edan",
  role:"Executive Producer"
},
{
  image:"https://is4-ssl.mzstatic.com/image/thumb/hhBxn73FHZT4ECFDFDQ16w/492x492ve.webp",
  name:"Shula spiegel",
  role:"Executive Producer"
},
{
  image:"https://is4-ssl.mzstatic.com/image/thumb/5Nq5KUnkSORoiNnlo_K9xA/492x492ve.webp",
  name:"Moshe Zonder",
  role:"writer"
},
{
  image:"https://is5-ssl.mzstatic.com/image/thumb/GKXDPNSb1cMpXvCggv9c7g/492x492ve.webp",
  name:"omrt shenhar",
  role:"writer"
},
{
  image:"https://is3-ssl.mzstatic.com/image/thumb/BSCS2A_rxa1NKXwrR20dkA/492x492ve.webp",
  name:"dana Eden",
  role:"creator"
},
];
